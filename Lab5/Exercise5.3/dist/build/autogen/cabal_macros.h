...
/* package distributed-process-0.5.5.1 */
#define VERSION_distributed_process "0.5.5.1"
#define MIN_VERSION_distributed_process(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  5 || \
  (major1) == 0 && (major2) == 5 && (minor) <= 5)

/* package distributed-process-simplelocalnet-0.2.3.1 */
#define VERSION_distributed_process_simplelocalnet "0.2.3.1"
...
#define CURRENT_PACKAGE_KEY "Exerc_EI95GOCdTAIKyHLpcqYHwB"
